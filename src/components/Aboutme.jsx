        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">
              Passionate MernStack Developer & Devops Expert
            </h3>

            <p className="text-gray-600 dark:text-gray-300">
              With over 3 year of experience in Mern Stack, I specialize in FullStack Solutions, accessible, and performant web applications using modern technologies.
            </p>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="border border-purple-500/30 p-6 rounded-lg hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-shadow duration-300 group bg-gray-100 dark:bg-gray-800">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  <h4 className="font-semibold text-lg group-hover:text-purple-400 transition-colors duration-300">FullStack Development</h4>
                  <p className="text-gray-600 dark:text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                    Creating real world Solutions and web applications with modern frameworks & technologies.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-purple-500/30 p-6 rounded-lg hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-shadow duration-300 group bg-gray-100 dark:bg-gray-800">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  <h4 className="font-semibold text-lg group-hover:text-purple-400 transition-colors duration-300">Deployment</h4>
                  <p className="text-gray-600 dark:text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                    Expertise in deploying Real world solutions and providing Maintaince with having two years of experience                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative w-full flex justify-start pl-4 pr-4 md:pr-0 md:pl-0">
                <div className="w-full md:w-5/12">
                  <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] transition-shadow duration-300 group relative">
                    ...
                    <h4 className="text-lg font-semibold mt-2 group-hover:text-white transition-colors duration-300">Adopted Redux</h4>
                    <p className="mt-2 text-gray-600 dark:text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                      Started using ReactJS for efficient and responsive styling in frontend projects at Saylani.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full flex justify-end pl-4 pr-4 md:pl-0 md:pr-0">
                <div className="w-full md:w-5/12">
                  <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] transition-shadow duration-300 group relative">
                    ...
                    <p className="mt-2 text-gray-600 dark:text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                      Completed a full-fledged Mern project using React,Redis,ExpressJS ,MongoDb and Tailwind CSS as part of Saylani's training.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full flex justify-start pl-4 pr-4 md:pr-0 md:pl-0">
                <div className="w-full md:w-5/12">
                  <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] transition-shadow duration-300 group relative">
                    ...
                    <h4 className="text-lg font-semibold mt-2 group-hover:text-white transition-colors duration-300">Certified Mernstack Developer</h4>
                    <p className="mt-2 text-gray-600 dark:text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                     Currently Working On real World solutions with using Mernstack Expertise and Managining System Architectre Using Expertise in AWS,DOCKER & CI/CD. 
                    </p>
                  </div>
                </div>
              </div>
