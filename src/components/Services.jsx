  ...
  const services = [
    {
      ...
      description: "Building responsive and interactive web applications using HTML, CSS, JavaScript, and frameworks like React and Nextjs.",
      icon: <Code className="h-8 w-8 text-purple-500" />
    },
    {
      id: 2,
     title: "Backend Development",
      description: "Building efficient Backend applications with a focus on Backend development. Specializing in creating Management ,Creating Real world AI Integrated  Solutions using Frameowrks like Nodejs, Expressjs, and Nestjs for advanced Real Full stack solutions.",
     icon: <BrainCircuit className="h-8 w-8 text-purple-500" />
    },
    {
      id: 3,
      title: "Deployment",
      description: "Ensuring your website performs perfectly across all devices, from mobile phones to desktops.",
      icon: <Smartphone className="h-8 w-8 text-purple-500" /> // Changed from Mobile to Smartphone
    },
    {
      id: 4,
      title: "Backend Optimization",
      description: "Ensuring Load Blalancing using Load balancer and For Caching using Reddis and some how using Kafka.",
